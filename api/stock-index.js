...
const COUNTRY_INDEX = {
  ...
  AE: { symbol: '^ADI', name: 'ADX General' },
  ...
  NG: { symbol: '^NGSEINDX', name: 'NGX All Share' },
  KE: { symbol: '^NSE20.NR', name: 'NSE 20' },
  CL: { symbol: '^IPSA', name: 'IPSA' },
  CO: { symbol: '^COLCAP', name: 'COLCAP' },
  PE: { symbol: '^SPBLPGPT', name: 'S&P Lima' },
  PK: { symbol: '^KSE100.KA', name: 'KSE 100' },
  BD: { symbol: '^DSEX', name: 'DSEX' },
