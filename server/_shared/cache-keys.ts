...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  climateAnomalies: 'slow', climateDisasters: 'slow', sanctionsPressure: 'slow', radiationWatch: 'slow', thermalEscalation: 'slow', crossSourceSignals: 'slow', cyberThreats: 'slow', techReadiness: 'slow',
