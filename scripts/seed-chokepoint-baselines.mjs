...
export const CHOKEPOINTS = [
  { id: 'hormuz',  name: 'Strait of Hormuz',    mbd: 21.0, lat: 26.6, lon: 56.3  },
  { id: 'malacca', name: 'Strait of Malacca',   mbd: 17.2, lat: 1.3,  lon: 103.8 },
  { id: 'suez',    name: 'Suez Canal / SUMED',  mbd: 7.6,  lat: 30.7, lon: 32.3  },
  { id: 'babelm',  name: 'Bab el-Mandeb',       mbd: 6.2,  lat: 12.6, lon: 43.4  },
  { id: 'danish',  name: 'Danish Straits',       mbd: 3.0,  lat: 57.5, lon: 10.5  },
  { id: 'turkish', name: 'Turkish Straits',      mbd: 2.9,  lat: 41.1, lon: 29.0  },
  { id: 'panama',  name: 'Panama Canal',         mbd: 0.9,  lat: 9.1,  lon: -79.7 },
];
