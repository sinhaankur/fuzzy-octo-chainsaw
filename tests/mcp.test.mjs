...
describe('api/mcp.ts — PRO MCP Server', () => {
  ...
  it('tools/list returns 27 tools with name, description, inputSchema', async () => {
    ...
    assert.equal(body.result.tools.length, 27, `Expected 27 tools, got ${body.result.tools.length}`);
