...
export const INTEL_TOPICS: IntelTopic[] = [
  {
    id: 'cyber',
    name: 'Cyber Threats',
    query: '(cyberattack OR ransomware OR hacking OR "data breach" OR APT)',
    icon: '🔓',
  ...
  },
  {
    ...
    query: '(military exercise OR troop deployment OR airstrike OR "naval exercise")',
    icon: '⚔️',
  ...
  },
  {
    id: 'nuclear',
    name: 'Nuclear',
    query: '(nuclear OR uranium enrichment OR IAEA OR "nuclear weapon" OR plutonium)',
    icon: '☢️',
  ...
  },
  {
    id: 'sanctions',
    name: 'Sanctions',
    query: '(sanctions OR embargo OR "trade war" OR tariff OR "economic pressure")',
    icon: '🚫',
  ...
  },
  {
    id: 'intelligence',
    name: 'Intelligence',
    query: '(espionage OR spy OR intelligence agency OR covert OR surveillance)',
    icon: '🕵️',
  ...
  },
  {
    ...
    query: '(naval blockade OR piracy OR "strait of hormuz" OR "south china sea" OR warship)',
    icon: '🚢',
